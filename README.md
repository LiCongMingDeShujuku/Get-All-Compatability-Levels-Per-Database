...
# 获取每个数据库的所有兼容性级别
#### Get All Compatability Levels Per Database
**发布-日期: 2014年10月14日 (评论)**
...
## 中文
这是一些可以返回每个数据库的所有兼容模式的快速SQL逻辑。


## English
Here’s some quick SQL Logic to return all the Compatability Modes per Database.
